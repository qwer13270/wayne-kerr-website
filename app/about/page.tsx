...
export default function AboutPage() {
  ...
  const milestones = [
    {
      ...
      description: 'Wayne Kerr Electronics was established in London, UK, beginning our journey in precision measurement.'
    },
    {
      year: '1960s',
      title: 'Industry Recognition',
      description: 'Gained worldwide recognition for quality and accuracy in component measurement products.'
    },
    {
      year: '1980s',
      title: 'Global Expansion',
      description: 'Established regional offices across continents to provide worldwide technical support.'
    },
    {
      year: '2000s',
      title: 'Technology Leadership',
      description: 'Became the world\'s leading manufacturer of electronic test equipment and LCR meters.'
    },
    {
      year: 'Today',
      title: '78+ Years of Excellence',
      description: 'Continuing to innovate and serve customers across 57 countries with precision solutions.'
    }
  ];
  ...
  const coreValues = [
    {
      icon: Lightbulb,
      title: 'Innovation',
      description: 'We pioneer advanced measurement technologies that set new industry standards for accuracy and reliability.',
      color: 'from-blue-600 to-blue-700'
    },
    {
      icon: Heart,
      title: 'Commitment',
      description: 'Our dedication to customer success drives us to deliver great service and support, ensuring satisfaction and trust.',
      color: 'from-blue-600 to-blue-700'
    },
    {
      icon: Shield,
      title: 'Quality',
      description: 'Every product we offer is a testament to our commitment to quality, designed for durability and performance.',
      color: 'from-blue-600 to-blue-700'
    }
  ];
  ...
  const highlights = [
    {
      icon: Award,
      title: 'Prestigious',
      description: 'Founded in 1946 in London, UK, Wayne Kerr Electronics has become the world\'s leading manufacturer of electronic test equipment over the past 78 years.'
    },
    {
      icon: Target,
      title: 'Professional',
      description: 'Specialized in providing the high accuracy, quality, and capabilities in component testing equipment (LCR Meter, Impedance Analyzer, High Frequency LCR Meter)'
    },
    {
      icon: GlobeIcon,
      title: 'Worldwide',
      description: 'Wayne Kerr Electronics has established regional offices in U.S.A, Germany, Singapore, India, Japan, China, and Taiwan for worldwide technical supports and services'
    }
  ];
  ...
  return (
    <div className={`min-h-screen ${bgColor} ${textColor} overflow-x-hidden transition-colors duration-300`}>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className={`text-2xl sm:text-3xl leading-relaxed font-light ${textSecondary}`}>
              Acknowledged worldwide for the quality, accuracy and capability of component measurement products
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className={`text-lg ${textSecondary} leading-relaxed`}>
                  Our mission is to revolutionize the field of component measurement through innovation, quality, and commitment. We aim to empower industries worldwide with precision tools that enhance efficiency and reliability.
                </p>
                
                <p className={`text-lg ${textSecondary} leading-relaxed`}>
                  By continuously advancing our technologies and services, we strive to exceed the expectations of our clients. Our focus on customer success is the driving force behind our pursuit of excellence in everything we do.
                </p>
            ...
            <div className="space-y-12">
              {milestones.map((milestone, index) => (
                <div key={index} className="relative pl-0 lg:pl-24">
                  ...
                  <div className={`${cardBg} border rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-all duration-300`}>
      ...
      <section className="py-20 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className={`text-xl ${textSecondary} max-w-3xl mx-auto`}>
              Regional offices providing worldwide technical support and services
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {globalOffices.map((office, index) => (
              <div key={index} className={`${cardBg} border rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}>
                <div className="flex items-start gap-3">
          ...
          <div className="text-center mt-12">
            <button className="btn-gradient px-8 py-4 text-lg inline-flex items-center gap-2">
              View All Locations
              <ArrowRight size={20} />
            </button>
          </div>
      ...
      {/* Footer */}
      <footer className={`${darkMode ? 'bg-black text-white' : 'bg-white text-gray-900'} py-12 sm:py-16 border-t ${darkMode ? 'border-gray-800' : 'border-gray-200'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className={`transition-colors ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>LCR Meters</a></li>
                <li><a href="#" className={`transition-colors ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>Accessories</a></li>
                <li><a href="#" className={`transition-colors ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>Software</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/about" className={`transition-colors ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>About Us</a></li>
                <li><a href="#" className={`transition-colors ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>News</a></li>
                <li><a href="#" className={`transition-colors ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>Careers</a></li>
                <li><a href="#" className={`transition-colors ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}>Contact</a></li>
              </ul>
            </div>
